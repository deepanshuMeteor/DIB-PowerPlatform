...
1.  On the **Upload a file** screen, select **Select from device**.
1.  From the **Class Files**(which you have downloaded in the lab_1), locate and open **Room Reservations.xlsx**.
...
1.You will see your account username on the top-right of the screen.
